    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                _c.sent();
                _c.label = 3;
            case 3: return [4 /*yield*/, profile_1.default.updateOne({ user: user._id }, __assign({}, updateProfileData))];
            case 4:
                _c.sent();
...
var findUserProfileOrFail = function (userId) { return __awaiter(void 0, void 0, void 0, function () {
    var user, profile;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, users_schema_1.default.findOne({ _id: userId })];
            case 1:
                user = _a.sent();
                if (!user)

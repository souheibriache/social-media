    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            new post_1.Comment(__assign(__assign({}, req.body), { post: postId, user: req.user._id })).save(),
          ];
        case 2:
          comment = _a.sent();
        ...
        case 3:
          ...
          return [
            ...
            res
              .status(200)
              .json({ error: false, message: 'Comment created successfully', payload: { comment: comment } }),
          ];
        case 4:
          err_1 = _a.sent();
...
var getPostComments = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            post_1.Comment.find({ post: postId })
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          return [
            2 /*return*/,
            res.status(200).json({ error: false, message: 'Get comment successfully', payload: { comment: comment } }),
          ];
        case 3:
          err_3 = _a.sent();

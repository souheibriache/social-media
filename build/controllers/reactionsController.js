    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 3:
          ...
          return [
            4 /*yield*/,
            new post_1.Reaction(__assign(__assign({}, req.body), { user: req.user._id, post: post._id })).save(),
          ];
        case 4:
          reaction = _a.sent();
        ...
        case 5:
          ...
          res
            .status(200)
            .json({ error: false, message: 'Reaction posted successfully', payload: { reaction: reaction } });
          return [2 /*return*/];
      }
    });
  });
};
var deleteReaction = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
...
var getPostReactions = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          res
            .status(200)
            .json({ error: false, message: 'Get reactions successfully', payload: { reactions: reactions } });
          return [3 /*break*/, 4];
        case 3:
          err_1 = _a.sent();

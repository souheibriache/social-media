...
var sendInvitation = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, invitation_1.Invitation.findOne({
                        sender: req.user._id,
                        receiver: receiverId,
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, invitation_1.Invitation.findOneAndUpdate({ _id: invitationId }, { status: 'cancelled' })];
            case 2:
                _a.sent();
...
var unfriendUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!receiver)
                    res.status(404).json({ error: true, message: 'User Not Found!' });
                return [4 /*yield*/, invitation_1.Invitation.findOne({ sender: req.user._id, receiver: receiverId, status: 'accepted' })];
            case 2:
                invitation = _a.sent();
                if (!invitation)
                    return [2 /*return*/, res.status(404).json({ error: true, message: 'Invitation Not Found!' })];
                return [4 /*yield*/, invitation_1.Invitation.findOneAndUpdate({ _id: invitation._id }, { status: 'cancelled' })];
            case 3:
                _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                invitationId = req.params.invitationId;
                return [4 /*yield*/, invitation_1.Invitation.findOne({ _id: invitationId, status: 'pending', receiver: req.user._id })];
            case 1:
                invitation = _a.sent();
                if (!invitation)
                    return [2 /*return*/, res.status(404).json({ error: true, message: 'Invitation Not Found!' })];
                return [4 /*yield*/, invitation_1.Invitation.findOneAndUpdate({ _id: invitation._id }, { status: 'accepted' })];
            case 2:
                _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!invitation)
                    return [2 /*return*/, res.status(404).json({ error: true, message: 'Invitation Not Found!' })];
                return [4 /*yield*/, invitation_1.Invitation.findOneAndUpdate({ _id: invitation._id }, { status: 'rejected' })];
            case 2:
                _a.sent();
...
var getSentInvitations = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var invitaitonsData;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getInvitation(req.user._id, 'sent')];
            case 1:
...
var getReceivedInvitations = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var invitaitonsData;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getInvitation(req.user._id, 'received')];
            case 1:
                invitaitonsData = _a.sent();
                return [2 /*return*/, res.status(invitaitonsData.statusCode).json(__assign({}, invitaitonsData.data))];
        }
...
var getInvitation = function (userId, invitationType) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, invitation_1.Invitation.find({ status: 'pending', sender: userId }).populate('receiver')];
            case 2:
                _a = _b.sent();
                return [3 /*break*/, 5];
            case 3: return [4 /*yield*/, invitation_1.Invitation.find({ status: 'pending', receiver: userId }).populate('sender')];
            case 4:
                _a = _b.sent();
                _b.label = 5;
            case 5:
